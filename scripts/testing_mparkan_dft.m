...
points = [base 'mparkan_dft/data/measurements/vector/als/'];

file = 'zh_2014_coniferous.las';
...
% original command doesn't have the first quote for the output path
  geotiffwrite([base '/mparkan_dft/data/measurements/raster/als/so_2014_woodland_pasture.tif'], ...
...
[point, tree] = treeRegionGrowing([xyz], ...
classification, ...
'classTerrain', [2], ...
