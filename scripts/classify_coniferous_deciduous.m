...
%% Subset based on coniferous / deciduous 


file = '631000_264000_leaf_off.mat';
leafoff = load([base 'data/KantonAargau/LeafOff/631000_264000_leaf_off.mat']);
leafon = load([base 'data/KantonAargau/LeafOn/631000_264000_leaf_on.mat']);

% polygon coordinates
% deciduous %tree_type = 'deciduous';
x_min = 631760;
x_max = 631860;
y_min = 264610;
y_max = 264710;
